...
// Increase payload limit for image uploads (default is 100kb)
...
// Landing page API - public endpoint (no auth required) - MUST BE BEFORE LOYALTY PROXY
...
// Salesforce Orders Endpoints (MUST be before /api/orders/:id to avoid route collision)
...
app.post('/api/products/generate-inventory', async (req, res) => {
  try {
    ...
    for (const update of updates) {
      ...
      // Add the product ID as the last parameter for the WHERE clause
